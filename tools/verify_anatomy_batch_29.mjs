...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-29.json");
const reviewedWarning = "Source page and external anatomy reference reviewed; remains an unapproved OCR draft.";
const restored = new Map([
  ["anatomy-anatomy-all-pdf-p0866-q0046", [866, 0]],
  ["anatomy-anatomy-all-pdf-p0869-q0047", [869, 4]],
  ["anatomy-anatomy-all-pdf-p0877-q0049", [877, 2]],
  ["anatomy-anatomy-all-pdf-p0881-q0050", [881, 2]],
  ["anatomy-anatomy-all-pdf-p0886-q0051", [886, 2]],
  ["anatomy-anatomy-all-pdf-p0891-q0052", [891, 3]],
  ["anatomy-anatomy-all-pdf-p0895-q0053", [895, 4]],
  ["anatomy-anatomy-all-pdf-p0900-q0054", [900, 1]],
  ["anatomy-anatomy-all-pdf-p0904-q0055", [904, 4]],
]);
const restricted = new Map([["anatomy-anatomy-all-pdf-p0872-q0048", 872]]);
...
if (artifact.applied.length !== restored.size || artifact.restricted.length !== restricted.size) throw new Error("Batch 29 artifact count mismatch.");
