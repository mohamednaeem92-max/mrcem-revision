/** Verifies post-application safeguards for Anatomy Batch 09. */
...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-09.json");
...
if (artifact.applied.length !== 6) throw new Error(`Expected six restored records, found ${artifact.applied.length}.`);
if (artifact.restricted.length !== 4) throw new Error(`Expected four restricted records, found ${artifact.restricted.length}.`);
