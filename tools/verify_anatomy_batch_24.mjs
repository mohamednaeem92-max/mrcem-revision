...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-24.json");
const reviewedWarning = "Source page and external anatomy reference reviewed; remains an unapproved OCR draft.";
const restored = new Map([
  ["anatomy-anatomy-all-pdf-p0676-q0059", [676, 2]],
  ["anatomy-anatomy-all-pdf-p0678-q0061", [678, 2]],
  ["anatomy-anatomy-all-pdf-p0680-q0063", [680, 1]],
  ["anatomy-anatomy-all-pdf-p0681-q0064", [681, 2]],
  ["anatomy-anatomy-all-pdf-p0682-q0065", [682, 1]],
  ["anatomy-anatomy-all-pdf-p0683-q0066", [683, 1]],
  ["anatomy-anatomy-all-pdf-p0684-q0001", [684, 0]]
]);
const restricted = new Map([["anatomy-anatomy-all-pdf-p0677-q0060", 677], ["anatomy-anatomy-all-pdf-p0679-q0062", 679], ["anatomy-anatomy-all-pdf-p0689-q0002", 689]]);
...
if (artifact.applied.length !== restored.size || artifact.restricted.length !== restricted.size) throw new Error("Batch 24 artifact count mismatch.");
