...
if (plan.length !== 10 || artifact.applied?.length !== 9 || artifact.restricted?.length !== 1 || artifact.automaticApproval !== false) throw new Error("Batch 61 artifact count/status contract failed");
...
console.log(JSON.stringify({ batch: 61, verified: 10, restored: 9, restricted: 1, automaticApproval: false, mockEligible: false }, null, 2));
