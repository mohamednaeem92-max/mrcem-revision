...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-17.json");
const reviewedWarning = "Source page and external anatomy reference reviewed; remains an unapproved OCR draft.";
const restored = new Map([
  ["anatomy-anatomy-all-pdf-p0575-q0167", { page: 575, key: 3 }],
  ["anatomy-anatomy-all-pdf-p0579-q0169", { page: 579, key: 2 }],
  ["anatomy-anatomy-all-pdf-p0580-q0170", { page: 580, key: 2 }],
  ["anatomy-anatomy-all-pdf-p0581-q0171", { page: 581, key: 3 }],
  ["anatomy-anatomy-all-pdf-p0583-q0173", { page: 583, key: 1 }],
  ["anatomy-anatomy-all-pdf-p0584-q0174", { page: 584, key: 3 }],
  ["anatomy-anatomy-all-pdf-p0585-q0175", { page: 585, key: 2 }],
  ["anatomy-anatomy-all-pdf-p0586-q0176", { page: 586, key: 2 }]
]);
const restricted = new Map([
  ["anatomy-anatomy-all-pdf-p0574-q0166", { page: 574 }],
  ["anatomy-anatomy-all-pdf-p0582-q0172", { page: 582 }]
]);
