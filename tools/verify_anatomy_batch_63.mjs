...
if (plan.length !== 10 || artifact.applied?.length !== 10 || artifact.restricted?.length !== 0 || artifact.automaticApproval !== false) throw new Error("Batch 63 artifact count/status contract failed");
...
console.log(JSON.stringify({ batch: 63, verified: 10, restored: 10, restricted: 0, automaticApproval: false, mockEligible: false }, null, 2));
