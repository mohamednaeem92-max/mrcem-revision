/** Verifies post-application safeguards for Anatomy Batch 11. */
...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-11.json");
...
if (artifact.applied.length !== 8 || artifact.restricted.length !== 2) throw new Error(`Expected 8 restored and 2 restricted records; found ${artifact.applied.length} and ${artifact.restricted.length}.`);
