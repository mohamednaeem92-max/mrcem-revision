...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-31.json");
const reviewedWarning = "Source page and external anatomy reference reviewed; remains an unapproved OCR draft.";
const restored = new Map([
  ["anatomy-anatomy-all-pdf-p0952-q0066", [952, 4]],
  ["anatomy-anatomy-all-pdf-p0960-q0068", [960, 2]],
  ["anatomy-anatomy-all-pdf-p0963-q0069", [963, 3]],
  ["anatomy-anatomy-all-pdf-p0971-q0071", [971, 0]],
  ["anatomy-anatomy-all-pdf-p0979-q0073", [979, 1]],
  ["anatomy-anatomy-all-pdf-p0982-q0074", [982, 1]],
  ["anatomy-anatomy-all-pdf-p0985-q0075", [985, 2]],
]);
const restricted = new Map([
  ["anatomy-anatomy-all-pdf-p0955-q0067", 955],
  ["anatomy-anatomy-all-pdf-p0966-q0070", 966],
  ["anatomy-anatomy-all-pdf-p0975-q0072", 975],
]);
...
if (artifact.applied.length !== restored.size || artifact.restricted.length !== restricted.size) throw new Error("Batch 31 artifact count mismatch.");
