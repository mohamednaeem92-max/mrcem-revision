...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-30.json");
const reviewedWarning = "Source page and external anatomy reference reviewed; remains an unapproved OCR draft.";
const restored = new Map([
  ["anatomy-anatomy-all-pdf-p0909-q0056", [909, 3]],
  ["anatomy-anatomy-all-pdf-p0916-q0058", [916, 4]],
  ["anatomy-anatomy-all-pdf-p0925-q0060", [925, 4]],
  ["anatomy-anatomy-all-pdf-p0936-q0062", [936, 1]],
  ["anatomy-anatomy-all-pdf-p0942-q0063", [942, 0]],
  ["anatomy-anatomy-all-pdf-p0945-q0064", [945, 2]],
]);
const restricted = new Map([
  ["anatomy-anatomy-all-pdf-p0913-q0057", 913],
  ["anatomy-anatomy-all-pdf-p0922-q0059", 922],
  ["anatomy-anatomy-all-pdf-p0931-q0061", 931],
  ["anatomy-anatomy-all-pdf-p0949-q0065", 949],
]);
...
if (artifact.applied.length !== restored.size || artifact.restricted.length !== restricted.size) throw new Error("Batch 30 artifact count mismatch.");
