...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-28.json");
const reviewedWarning = "Source page and external anatomy reference reviewed; remains an unapproved OCR draft.";
const restored = new Map([
  ["anatomy-anatomy-all-pdf-p0826-q0036", [826, 0]],
  ["anatomy-anatomy-all-pdf-p0829-q0037", [829, 4]],
  ["anatomy-anatomy-all-pdf-p0836-q0038", [836, 3]],
  ["anatomy-anatomy-all-pdf-p0844-q0040", [844, 1]],
  ["anatomy-anatomy-all-pdf-p0847-q0041", [847, 0]],
  ["anatomy-anatomy-all-pdf-p0850-q0042", [850, 2]],
  ["anatomy-anatomy-all-pdf-p0855-q0043", [855, 1]],
  ["anatomy-anatomy-all-pdf-p0858-q0044", [858, 1]],
]);
const restricted = new Map([
  ["anatomy-anatomy-all-pdf-p0840-q0039", 840],
  ["anatomy-anatomy-all-pdf-p0862-q0045", 862],
]);
...
if (artifact.applied.length !== restored.size || artifact.restricted.length !== restricted.size) throw new Error("Batch 28 artifact count mismatch.");
