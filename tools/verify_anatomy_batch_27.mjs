...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-27.json");
const reviewedWarning = "Source page and external anatomy reference reviewed; remains an unapproved OCR draft.";
const restored = new Map([
  ["anatomy-anatomy-all-pdf-p0787-q0024", [787, 4]],
  ["anatomy-anatomy-all-pdf-p0791-q0025", [791, 2]],
  ["anatomy-anatomy-all-pdf-p0795-q0026", [795, 1]],
  ["anatomy-anatomy-all-pdf-p0802-q0029", [802, 2]],
  ["anatomy-anatomy-all-pdf-p0809-q0031", [809, 2]],
  ["anatomy-anatomy-all-pdf-p0817-q0033", [817, 1]],
  ["anatomy-anatomy-all-pdf-p0820-q0034", [820, 3]],
  ["anatomy-anatomy-all-pdf-p0823-q0035", [823, 1]],
]);
const restricted = new Map([
  ["anatomy-anatomy-all-pdf-p0805-q0030", 805],
  ["anatomy-anatomy-all-pdf-p0813-q0032", 813],
]);
...
if (artifact.applied.length !== restored.size || artifact.restricted.length !== restricted.size) throw new Error("Batch 27 artifact count mismatch.");
