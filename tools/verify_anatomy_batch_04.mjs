/** Verifies post-application safeguards for Anatomy Batch 04. */
...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-04.json");
...
if (artifact.applied.length !== 9) throw new Error(`Expected nine restored records, found ${artifact.applied.length}.`);
if (artifact.restricted.length !== 1) throw new Error(`Expected one restricted record, found ${artifact.restricted.length}.`);
