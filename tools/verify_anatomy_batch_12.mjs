/** Verifies post-application safeguards for Anatomy Batch 12. */
...
const artifactPath = path.join(root, "docs", "audit", "applied-anatomy-batch-12.json");
...
if (artifact.applied.length !== 9 || artifact.restricted.length !== 1) throw new Error(`Expected 9 restored and 1 restricted records; found ${artifact.applied.length} and ${artifact.restricted.length}.`);
